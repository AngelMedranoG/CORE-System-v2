                    ...
                    <tbody class="text-gray-600 fw-semibold">
                        ...
                        @forelse ($categorias as $categoria)
                            ...
                            <tr>
                                ...
                                <td>{{ $categoria->nombre_corto }}</td>
                                <td>
                                    @if ($categoria->mostrar_bot)
                                        Sí
                                    @else
                                        No
                                    @endif
                                </td>
                                <td>{{ $categoria->getCreatedAtFormatted() }}</td>
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" data-kt-menu="true">  
                                        <div class="menu-item px-3">
                                            <a href="{{ route('sistema.atencion-digital.subcategorias.index', $categoria->id) }}" class="menu-link px-3">
                                                <i class="ki-duotone ki-burger-menu-5 fs-5 me-2">
                                                </i>
                                                Subcategorías
                                            </a>
                                        </div>
                                        <div class="menu-item px-3">
                                            <a href="{{ route('sistema.atencion-digital.categorias.edit', $categoria->id) }}" class="menu-link px-3">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="#" wire:click="$dispatch('dataDelete', {{ $categoria->id }})" class="menu-link px-3">
            ...
            Livewire.on('dataDelete', dataID => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Livewire.dispatch('deleteCategoria', {categoriaId: dataID});
