    ...
    <div class="card-header border-0 pt-6">
        <div class="card-title">
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" wire:model.live="search" class="form-control form-control-solid w-250px ps-13" placeholder="Buscar subcategoría">
            </div>
        </div>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" data-kt-menu="true">  
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('sistema.atencion-digital.subcategorias.edit', [$categoria->id, $subcategoria->id]) }}" class="menu-link px-3">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="#" wire:click="$dispatch('dataDelete', {{ $subcategoria->id }})" class="menu-link px-3">
            ...
            Livewire.on('dataDelete', dataID => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Livewire.dispatch('deleteSubcategoria', {subcategoriaId: dataID});
