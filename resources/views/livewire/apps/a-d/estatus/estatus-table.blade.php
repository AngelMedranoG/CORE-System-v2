    ...
    <div class="card-header border-0 pt-6">
        <div class="card-title">
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" wire:model.live="search" class="form-control form-control-solid w-250px ps-13" placeholder="Buscar estatus">
            </div>
        </div>
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_table">
                    <thead>
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            <th class="min-w-125px" tabindex="0" aria-controls="kt_table" aria-label="Nombre del estatus">
                                Nombre
                            </th>
                    ...
                    <tbody class="text-gray-600 fw-semibold">
                        ...
                        @forelse ($estatusList as $estatus)

                            <tr>
                                <td>{{ $estatus->nombre }}</td>
                                <td>{{ $estatus->getCreatedAtFormatted() }}</td>
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" data-kt-menu="true">  
                                        <div class="menu-item px-3">
                                            <a href="{{ route('sistema.atencion-digital.estatus.edit', $estatus->id) }}" class="menu-link px-3">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="#" wire:click="$dispatch('dataDelete', {{ $estatus->id }})" class="menu-link px-3">
            ...
            Livewire.on('dataDelete', dataID => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Livewire.dispatch('deleteEstatus', {estatusId: dataID});
