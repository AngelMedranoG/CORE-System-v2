...
class SubcategoriasCreate extends Component {
    ...
    public function submit() {
        ...
        try {
            ...
            toastr()->success('La subcategoría ha sido registrada correctamente.', 'Subcategorías', ["positionClass" => "toast-top-right"]);
    ...
    public function render() {
        return view('livewire.apps.a-d.subcategorias.subcategorias-create');
    }
